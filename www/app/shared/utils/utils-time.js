...
(function () {
    ...
    angular.module('Utils').service('TimeUtils', TimeUtilService);
    ...
    function TimeUtilService() {
        ...
        function daysTo(value, tovalue) {
            ...
            if (values.length === 3) {
                return (todayArray[2] - values[2]) * 365 + (todayArray[1] - values[1]) * 30 + (todayArray[0] - values[0]);
            }
        ...
        function convertHl7dateTojsDate(hl7Date) {
            ...
            var outdate = year + '-' + month + '-' + day + 'T' + hour + ':' + minute + ':' + second + '.' + miliseconds + GMT;
