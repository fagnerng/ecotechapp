...
(function () {
    ...
    angular.module('Utils').service('AnimationFrame', AnimationFrame);
    /**
    ...
    function AnimationFrame($timeout) {
        ...
        var mCancelAnimationFrame = (function () {
            return window.cancelAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || function (timeoutId) {
